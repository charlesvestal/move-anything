...
FB="/data/UserData/move-anything/bin/filebrowser"
FB_FLAG="/data/UserData/move-anything/filebrowser_enabled"
if [ -x "$FB" ] && [ -f "$FB_FLAG" ]; then
    "$FB" \
        ...
        --port 404 \
        --root /data/UserData \
        --database /data/UserData/move-anything/filebrowser.db \
        --disableThumbnails \
