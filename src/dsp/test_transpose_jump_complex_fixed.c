/*
 * Complex test for transpose jump scenarios - UPDATED WITH FIX
 *
 * Tests:
...
/* FIXED: Separate update and get functions */
...
void test_backward_jump(void) {
    ...
    int errors = 0;
    for (int i = 0; i < 10; i++) {
        update_transpose_virtual_playhead(i);
...
void test_skip_step(void) {
    ...
    g_transpose_sequence[1].transpose = 99;
    g_transpose_sequence[1].duration = 2;
    g_transpose_sequence[1].jump = -1;
    g_transpose_sequence[1].condition_n = 0;
...
void test_realistic_scenario(void) {
    ...
    /* Test step 16 */
    update_transpose_virtual_playhead(16);
    int8_t t16 = get_transpose_at_step();
    ...
    /* Test step 32 */
    update_transpose_virtual_playhead(32);
    int8_t t32 = get_transpose_at_step();
...
int main() {
    printf("Transpose Jump Comprehensive Test Suite (FIXED)\n");
    printf("================================================\n");
    ...
    printf("\n================================================\n");
    printf("All tests completed with FIXED implementation.\n");
